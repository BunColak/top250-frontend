...
const Suggestion = ({ movie, newSuggestion, closeSuggestion, refetch }: Props) => {
  ...
  return (
        <div className="fixed top-0 left-0 w-full h-full text-black text-center">
            ...
            <div className="fixed top-1/2 left-1/2 w-1/3 h-1/3 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-sm p-4 flex flex-col items-center justify-center" >
